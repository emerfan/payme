...
public interface InvoiceRepository extends JpaRepository<Invoice, Long> {
	...
	/**
	 * The findByIds method. Return the invoice
	 * matching the id passed.
	 */
	Optional<Invoice> findById(Long id);
	
	/**
	 * The findByCustomerId method. Retrieve all invoices
	 * with a customer id matching the one passed
	 * @param id
	 * @return
	 */
	...
	/**
	 * The findByIsPaid method. Retrieve all invoices
	...
	/**
	 * The findByInvoiceDateBetween method. Retrieve all
	 * invoices between the dates passed.
	 * 
	...
	/**
	 * The findByCustomerIdAndInvoiceDateBetween method. Find by customer id
	 ...
	 * @return
	 */
	Iterable<Invoice> findByCustomerIdAndInvoiceDateBetween(
			Long customerId,
			Date invoiceDateStart, 
			Date invoiceDateEnd);
	
	/**
	 * The findByIsPaidAndInvoiceDateBetween method. Find all invoices
	 ...
	 * @return
	 */
	Iterable<Invoice> findByIsPaidAndInvoiceDateBetween(
			Boolean isPaid,
			Date invoiceDateStart, 
			Date invoiceDateEnd);
	
	/**
	 * The findByCustomerIdAndIsPaidAndInvoiceDateBetween method
	 ...
	 * @return
	 */
	Iterable<Invoice> findByCustomerIdAndIsPaidAndInvoiceDateBetween(
			Long customerId,
			Boolean isPaid,
			Date invoiceDateStart, 
			Date invoiceDateEnd);
