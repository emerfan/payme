...
public class InvoicePdfBuilder {
	 ...
	 */
	  public byte[] createPdf(Invoice inv, String salon) throws IOException, DocumentException {
	        ...
	        Paragraph addc1 = new Paragraph(salon);
	 ...
	 * @param table
	 */
	private void addVatAndTotals(Invoice inv, PdfPTable table) {
		// EX VAT
	 ...
	 * @param table
	 */
	private void addInvoiceItems(Invoice inv, PdfPTable table) {
	 ...
	 * @return
	 */
	private PdfPTable createPdfInvoiceTitle(Invoice inv) {
